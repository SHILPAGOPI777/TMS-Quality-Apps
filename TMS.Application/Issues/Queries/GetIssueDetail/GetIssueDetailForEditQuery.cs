...
{
    public class GetLeaveDetailForEditQuery : IRequest<IssueDetailForUpsertVm>
    {
        public long IssueId { get; set; }

        public class GetIssueDetailForEditQueryHandler : IRequestHandler<GetLeaveDetailForEditQuery, IssueDetailForUpsertVm>
        {
            ...
            public async Task<IssueDetailForUpsertVm> Handle(GetLeaveDetailForEditQuery request, CancellationToken cancellationToken)
            {
